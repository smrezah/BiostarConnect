...
namespace webRestaurantBS.SFBioClasses
{
    ...
    public class UserControl : FunctionModule
    {
        ...
        public void insertUserIntoDatabase(IntPtr sdkContext, UInt32 deviceID, bool isMasterDevice)
        {
            ...
            if (Util.IsYes())
            {
                ...
                using var profileImage = SixLabors.ImageSharp.Image.Load(imagePath);
                if (profileImage.Metadata.DecodedImageFormat is not JpegFormat)
                {
